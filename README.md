08-08-2024:
- OPT - экспорт сортирует сам список, а не вывод

05-08-2024:
- разобраться с вызовом minishell (обработка только с ./ b и починить выход) - done

03-08-2024:
- починить лики при export TEST несколько раз - done
- починить export test=100 несколько  раз - done
  
02-08-2024:
- починить unset arg - done
...
===================================================================
EXPORT - TODO
- Изменение SHLVL - done
- Обнуление OLDPWD
CD - TODO
- обработка случая удаления директории из самой директории - done
